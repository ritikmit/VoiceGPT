...
export default function Preference({
  ...
  const [tempCreativityPreference, setTempCreativityPreference] =
    useState(creativityPreference);
  const [tempLengthPreference, setTempLengthPreference] =
    useState(lengthPreference);

  const handleTempCreativityPreferenceChange = (
    ...
    <SafeAreaView style={styles.container}>
      <SafeAreaView style={styles.preferenceContainer}>
        ...
        <TouchableOpacity
          style={[
            ...
            tempCreativityPreference === CreativityPreference.PRESERVED &&
              styles.selectedPreferenceButton,
          ]}
          onPress={() =>
            handleTempCreativityPreferenceChange(CreativityPreference.PRESERVED)
          }>
        ...
        <TouchableOpacity
          style={[
            styles.preferenceButton,
            tempCreativityPreference === CreativityPreference.BALANCE &&
              styles.selectedPreferenceButton,
          ]}
          onPress={() =>
            handleTempCreativityPreferenceChange(CreativityPreference.BALANCE)
          }>
        ...
        <TouchableOpacity
          style={[
            styles.preferenceButton,
            tempCreativityPreference === CreativityPreference.CREATIVE &&
              styles.selectedPreferenceButton,
          ]}
          onPress={() =>
            handleTempCreativityPreferenceChange(CreativityPreference.CREATIVE)
          }>
      ...
      <SafeAreaView style={styles.preferenceContainer}>
        ...
        <TouchableOpacity
          style={[
            styles.preferenceButton,
            tempLengthPreference === LengthPreference.DETAILED &&
              styles.selectedPreferenceButton,
          ]}
          onPress={() =>
            handleTempLengthPreferenceChange(LengthPreference.DETAILED)
          }>
        ...
        <TouchableOpacity
          style={[
            styles.preferenceButton,
            tempLengthPreference === LengthPreference.CASUAL &&
              styles.selectedPreferenceButton,
          ]}
          onPress={() =>
            handleTempLengthPreferenceChange(LengthPreference.CASUAL)
          }>
        ...
        <TouchableOpacity
          style={[
            styles.preferenceButton,
            tempLengthPreference === LengthPreference.CRISP &&
              styles.selectedPreferenceButton,
          ]}
          onPress={() =>
            handleTempLengthPreferenceChange(LengthPreference.CRISP)
          }>
